...
export const STR = {
  ...
  settings: {
    ...
    removeAdsSection: 'PURCHASES',
    removeAdsAvailable: (price: string) => `Remove ads · ${price}`,
    removeAdsAvailableHint: 'One-time purchase. Hides the banner and interstitials.',
    removeAdsOwned: 'Ads removed  ✓',
    removeAdsOwnedHint: 'Thanks for supporting Neon Dodge!',
    restorePurchases: 'Restore purchases',
    restorePurchasesHint: 'Reinstalled? Restore prior purchases.',
    purchaseErrorTitle: 'Purchase unavailable',
    purchaseErrorMessage: 'The store did not respond. Please try again.',
    restoreNoneTitle: 'Nothing to restore',
    restoreNoneMessage: 'No prior Remove Ads purchase found on this store account.',
    restoreOkTitle: 'Restored',
    restoreOkMessage: 'Your Remove Ads purchase has been restored.',
    okBtn: 'OK',
    done: 'DONE',
